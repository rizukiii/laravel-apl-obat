        ...
        <div class="container my-3">
            ...
            <div class="row">
                <div class="col-8">
                    ...
                    <form action="{{ route('clasification.index') }}" method="get">
                        ...
                        <tbody>
                            @forelse ($clasification as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('clasification.edit', $item->id) }}">Edit</a>
                                        <a href="{{ route('clasification.destroy', $item->id) }}"
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        {{ $clasification->links('pagination::bootstrap-5') }}
                    </div>
                </div>
                <div class="col-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('clasification.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
